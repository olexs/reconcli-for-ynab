...
program
    ...
    .option('--op-item <item>',
        '1Password: name of item',
        'YNAB')
    .option('--op-field-label <field-label>',
        '1Password: label of field containing the token',
        'personal access token')
    .option('-b, --budget <budget>',
        'Name of the YNAB budget (leave empty if there is only one budget in the account, or if the default budget is set)')
